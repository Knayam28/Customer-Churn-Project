...
* **Modeling:** Trained and evaluated a **Random Forest Classifier** to accurately capture complex, non-linear relationships in customer behavior.
* **Deployment:** Built a monolithic Streamlit dashboard to ensure fast, responsive performance when hosted on the Streamlit Community Cloud.
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/](https://github.com/)[YOUR_GITHUB_USERNAME]/customer-churn-project.git
